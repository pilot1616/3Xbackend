...
- 首页已接真实帖子列表、单帖详情跳转、点赞切换、点赞列表分页查看、评论分页、评论时间线展示、评论提交、评论编辑、评论删除
- 认证页已接真实登录、注册、重置密码，并补了手机号/密码/密保字段前端校验
- 发帖页已接真实发帖、附件上传、上传进度、帖子编辑、删除、发布状态切换、附件删除，并补了关键字筛选、本地附件预览、文件类型与大小校验
- 单帖详情页已接作者更多帖子联动
...
1. 继续打磨单帖详情交互，比如更完整的相关推荐策略。
2. 给发帖页补已上传附件的更细筛选或批量操作。
