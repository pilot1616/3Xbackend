...
- 首页已接真实帖子列表、点赞切换、点赞列表查看、评论提交、评论编辑、评论删除
- 认证页已接真实登录、注册、重置密码
- 发帖页已接真实发帖、附件上传、帖子编辑、删除、发布状态切换、附件删除
- 相册页已接“我的帖子”附件聚合展示
- 资料页已接真实资料读取、资料更新、头像上传、我的评论、我的点赞、统计汇总
...
1. 给首页补评论分页和更细的帖子详情交互，而不是只依赖列表内展开。
2. 给发帖页补帖子筛选、附件预览、上传进度和更明确的权限提示。
3. 把资料页和认证页表单校验做完整，减少后端报错后才反馈。
